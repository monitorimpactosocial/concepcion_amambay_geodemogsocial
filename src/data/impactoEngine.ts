...
export const ESCENARIOS_PRESET: Record<EscenarioKey, ImpactoParams> = {
  conservador: {
    ...
    empleoDirectoOperacion: 900,
    multiplicadorIndirecto: 2.6,
    coeficienteInducido: 1.4,
    capturaLocal_pct: 35,
    pctNoLocales: 65,
  ...
  medio: {
    ...
    empleoDirectoOperacion: 1040,
    multiplicadorIndirecto: 4.0,
    coeficienteInducido: 3.0,
    capturaLocal_pct: 55,
    pctNoLocales: 45,
    ...
    presupuestoComprasAnualGs: 140_000_000_000,
    pctComprasLocales: 30,
    anioInicioObra: 2026,
    duracionObraAnios: 3,
  },
  transformador: {
    empleoDirectoObra: 2400,
    empleoDirectoOperacion: 1300,
    multiplicadorIndirecto: 5.0,
    coeficienteInducido: 5.5,
    capturaLocal_pct: 75,
    pctNoLocales: 25,
    ...
    presupuestoComprasAnualGs: 220_000_000_000,
